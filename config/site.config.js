...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'wargod@craft-hello.top',
  ...
  email: 'mailto:wargod@craft-hello.top',
  ...
  links: [
    {
       name: 'BiliBili',
       link: 'https://space.bilibili.com/85304627',
    },
  ],
